...
/**
 * This class provides utility methods for parsing XML files, generating timestamps, and logging.
 */
public class TestUtils {
    public static final long WAIT = 10;

    /**
     * Parses an XML file containing string resources and returns a HashMap of key-value pairs.
     *
     * @param file The InputStream of the XML file.
     * @return A HashMap containing the string resources with their names as keys and values as values.
